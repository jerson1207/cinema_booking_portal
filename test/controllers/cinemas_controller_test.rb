...
class CinemasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cinema" do
    assert_difference("Cinema.count") do
      post cinemas_url, params: { cinema: { movie_title: @cinema.movie_title, name: @cinema.name } }
    end
  ...
  test "should update cinema" do
    patch cinema_url(@cinema), params: { cinema: { movie_title: @cinema.movie_title, name: @cinema.name } }
