...
class TimeSlotsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create time_slot" do
    assert_difference("TimeSlot.count") do
      post time_slots_url, params: { time_slot: { cinema_id: @time_slot.cinema_id, name: @time_slot.name, seat_id: @time_slot.seat_id } }
    end
  ...
  test "should update time_slot" do
    patch time_slot_url(@time_slot), params: { time_slot: { cinema_id: @time_slot.cinema_id, name: @time_slot.name, seat_id: @time_slot.seat_id } }
